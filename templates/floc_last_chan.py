...
class LastChannel:
    """This is a class for the last channel in the flocculator. It's called by
    the flocculator class so that the hierarchy of objects in Python is the same
    as in Fusion.

    Attributes
    ----------
    These are the default values for a last channel assembly. To overwrite, pass these
